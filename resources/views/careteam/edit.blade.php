...
const careteam = new Vue ({
    ...
    data: {
        member: {
            ...
            id: {{$member->id}},
            permissions: {
                carehub: {{ intval($member->permissions->permissions['carehub']) }},
                lockbox: {{ intval($member->permissions->permissions['lockbox']) }},
                medlist: {{ intval($member->permissions->permissions['medlist']) }},
                resources: {{ intval($member->permissions->permissions['resources']) }},
            },
        },
        action: '',
