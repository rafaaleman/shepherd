    ...
    <div class="modal-dialog modal-dialog-centered " role="document">
        ...
        <div class="modal-body row">
            ...
            <fieldset id="tab011" class="show col-md-12 p-3">
                ...
                <div class="mb-4">
                    <input id="name" type="text" class="form-control mr-2"  name="name" autofocus required v-model="document.name" >
                        ...
                        <tr v-for="c in careteam">
                            ...
                            <td class="text-center">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" :disabled="c.careteam.role == 'admin'" :checked="c.careteam.role == 'admin'" :id=`read-${c.id}` @change="assignPermission(c.id)">
